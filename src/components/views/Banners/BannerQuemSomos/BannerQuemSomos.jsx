    ...
    <StyleQuemSomos>
      <section className="quemSomos">
        ...
        <p>
          ...
          transformar a forma como as pessoas vivenciam filmes, tudo partiu de uma simples ideia, proporcionar aos nossos clientes
          não apenas filmes excepcionais, mas também uma maneira mais fácil e
          confortável de assisti-los.
        </p>

        <h2>Nossa História </h2>
        <p>
          Tudo começou como um sonho compartilhado por cinco amigos que
          acreditavam que o entretenimento cinematográfico deveria ser acessível
          e sem complicações. Cansados de ver pessoas enfrentando longas filas e
          deslocamentos apenas para garantir um lugar em seu filme favorito,
          decidimos criar uma solução inovadora. Assim, em uma noite cheia de
          entusiasmo e determinação, nasceu o Cinema Cine Samurai.
        </p>
